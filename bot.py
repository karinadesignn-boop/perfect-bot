...
Когда: пользователь хочет увидеть/посмотреть/узнать что запланировано на день. Любые формулировки: «план на сегодня», «что у меня сегодня», «мой день», «что завтра», «покажи день», «что запланировано на 6 июля».
date=YYYY-MM-DD.
