...
❗ Если есть любое из этих слов: «измени», «поменяй», «скорректируй», «исправь», «перенеси», «сдвинь», «поправь», «отредактируй», «уточни», «не в X а в Y», «теперь будет», «будет в» — ЭТО ВСЕГДА update, НИКОГДА не plan!
old_text = 1-3 ключевых слова существующего дела для поиска
date/time = новые значения (если меняются)
Время «16-18:00» / «с 16 до 18» / «16-18» → time="16:00"
Примеры:
«измени встречу: теперь в 17» → old_text="встреча", time="17:00"
«скорректируй йогу — будет в 9 утра» → old_text="йога", time="09:00"
«поправь задачу на завтра: теперь в 16-18:00» → old_text="задача", time="16:00"
«перенеси звонок на пятницу» → old_text="звонок", date={_this_fri}
...
«врача перенеси на четверг в 14:00» → old_text="врач", date=ближайший четверг, time="14:00"
«вместо встречи в среду поставь в четверг» → old_text="встреча", date=ближайший четверг
