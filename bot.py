...
show_day — пользователь хочет УВИДЕТЬ план на конкретный день.
Триггеры: «скинь», «покажи», «что у меня», «план», «расписание», «день» + любое указание на день.
...
plan — записать новое дело с датой или временем.
Примеры: «встреча в пятницу», «7 июля врач», «завтра в 10 йога».
